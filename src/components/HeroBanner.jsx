...
const HeroBanner = () => {
  return (
    <div className="relative text-white text-[20px] w-full max-w-[1360px] max-h-[300px] md:max-h-[600px] mx-auto">
      <Carousel
        autoPlay={true}
        infiniteLoop={true}
        showThumbs={false}
        ...
        {CarouselData.map((item, index) => {
          return (
            <div key={index}>
              <img
                src={item.img}
                className="aspect-[16/10] md:aspect-auto h-[300px] md:h-[600px] object-cover"
              />
