...
const Footer = () => {
  return (
    <footer className="bg-[var(--primary-c)] text-black pt-14 pb-3 ">
      <Wrapper className="flex justify-between flex-col md:flex-row gap-[50px] md:gap-0">
        ...
        <div className="flex gap-[50px] md:gap-[75px] lg:gap-[100px] flex-col md:flex-row">
          ...
          <div className="flex flex-col gap-3 shrink-0">
            ...
            <div className="font-medium text-md cursor-pointer  hover:text-white duration-200">
              Register Now
            </div>
            <div className="font-medium text-md cursor-pointer  hover:text-white duration-200">
              My Profile
          ...
          <div className="flex gap-[50px] md:gap-[75px] lg:gap-[100px] shrink-0">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link
                to={"/about"}
                className="text-md hover:text-white duration-200 cursor-pointer"
              >
                About Us
              </Link>
              <div className="text-md hover:text-white duration-200 cursor-pointer">
                Order Policy
              </div>
              <div className="text-md hover:text-white duration-200 cursor-pointer">
                Return Policy
      ...
      <Wrapper className="flex justify-between mt-10 flex-col md:flex-row gap-[10px] md:gap-0">
        {/* LEFT START */}
        <div className="text-[12pmd  text-center md:text-left">
